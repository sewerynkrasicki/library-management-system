...
public class ShowBooks extends javax.swing.JFrame {
    ...
    public ShowBooks() {
        try {
            ...
            showBookTable.setModel(bdtm.dtmBooks());
        } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        showBookTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tytuł", "Autor", "Rok_wydania", "Cena_biblioteki", "Wydawnictwo", "Kategoria"
            }
        ));
        jScrollPane1.setViewportView(showBookTable);
    ...
    private javax.swing.JTable showBookTable;
